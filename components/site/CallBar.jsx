    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-line bg-surface/95 backdrop-blur-md sm:hidden">
      <div className="grid grid-cols-2 gap-2 p-2.5">
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-control bg-brand px-4 py-3 text-[15px] font-semibold text-on-brand active:translate-y-px"
        >
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-control border border-line bg-surface-3 px-4 py-3 text-[15px] font-semibold text-text active:translate-y-px"
        >
